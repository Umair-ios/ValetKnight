...
NSString *const apiKey = @"AIzaSyByboue4BEXZk_q0UDH81abfs3UGpySHoA";
...
- (void)viewDidLoad {
    ...
    dictAddress = [[NSMutableDictionary alloc]initWithCapacity:0];
    ...
    [self.navigationController.navigationBar setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                                                     ...
                                                                     [UIFont fontWithName:@"OpenSans" size:18.0], NSFontAttributeName, nil]];
}
    ...
    switch (indexPath.section) {
        case TableViewSectionMain: {
            ...
            [self retrieveJSONDetailsAbout:placeID withCompletion:^(NSArray *place) {
                NSString *strPlaceName = [place valueForKey:@"name"];
                NSString *strPlaceAddress = [place valueForKey:@"formatted_address"];
                ...
                [dictAddress setValue:strPlaceName forKey:@"name"];
                [dictAddress setValue:strPlaceAddress forKey:@"address"];
                [dictAddress setValue:latitude forKey:@"placeLat"];
                [dictAddress setValue:longitude forKey:@"placeLong"];
                [dictAddress setValue:self.fromTextField forKey:PREF_ADDRESS_TYPE];
                
                NSUserDefaults *pref = [NSUserDefaults standardUserDefaults];
                if ([self.fromTextField isEqualToString:PREF_DEST_ADD]) {
                    [pref setObject:@"1" forKey:PREF_IS_OPTIONS];
                }
                
                [pref setValue:dictAddress forKey:PREF_FULL_ADDRESS];
                [pref synchronize];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.section) {
        case TableViewSectionMain: {
            ...
            cell.detailTextLabel.font = [UIFont fontWithName:@"OpenSans-Light" size:10.0];
        }break;
